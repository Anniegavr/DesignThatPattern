package com.example.lab2.domain.security.services;
...
public class ClientDetailsImpl implements UserDetails {
    ...
    public ClientDetailsImpl(Long ownerId, String username, String email, String password, List<GrantedAuthority> authorities) {
        this.id = ownerId;
    ...
    public static ClientDetailsImpl build(Owner owner) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        ClientDetailsImpl owner = (ClientDetailsImpl) o;
